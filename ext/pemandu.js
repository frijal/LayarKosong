...
<a href="https://x.com/intent/post?text=${q}&url=${P}" onclick="window.open(this.href,'_blank','noopener,noreferrer,width=600,height=400');return false;" title="Bagikan ke X" aria-label="Bagikan ke X">
...
<a href="https://www.facebook.com/sharer/sharer.php?u=${P}&t=${q}" onclick="window.open(this.href,'_blank','noopener,noreferrer,width=600,height=400');return false;" title="Bagikan ke Facebook" aria-label="Bagikan ke Facebook">
...
<a href="https://api.whatsapp.com/send?text=${q}%0A%0A${P}" onclick="window.open(this.href,'_blank','noopener,noreferrer,width=600,height=400');return false;" title="Bagikan ke WhatsApp" aria-label="Bagikan ke WhatsApp">
...
<a href="https://www.threads.com/intent/post?text=${q}&url=${P}" onclick="window.open(this.href,'_blank','noopener,noreferrer,width=600,height=400');return false;" title="Bagikan ke Threads" aria-label="Bagikan ke Threads">
...
<a href="https://share.flipboard.com/bookmarklet/popout?v=2&title=${q}&url=${P}&utm_source=dalam.web.id" onclick="window.open(this.href,'_blank','noopener,noreferrer,width=600,height=600');return false;" title="Bagikan ke Flipboard" aria-label="Bagikan ke Flipboard">
