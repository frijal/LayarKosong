...
def main():
    ...
    # Header dengan Quote Block (Memenuhi Warning)
...
"""
    ...
    header = [
        ...
        f"> Total {total_articles} artikel berhasil diindeks dalam versi {new_v}.",
        ""
    ]
...
<head>
    ...
    <style>
        body {{ font-family: system-ui, sans-serif; margin: 2em auto; max-width: 900px; padding: 1em; line-height: 1.6; }}
        pre {{ background: #1e1e1e; color: #dcdcdc; padding: 1.5em; border-radius: 8px; overflow-x: auto; white-space: pre-wrap; }}
        blockquote {{ border-left: 5px solid #ccc; padding-left: 1em; color: #666; font-style: italic; }}
