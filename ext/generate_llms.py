    ...
    try:
        ...
        for category_key, articles in data.items():
            ...
            for item in sorted_articles:
                ...
                temp_lines.append(f"- [{title}]({DOMAIN}/artikel/{slug}) : {summary}[Last modified: {date_str}]")
                article_count += 1
...
def main():
    ...
    ai_instructions = f"""# LLM Instructions for AI Models, Applies to: ChatGPT, Gemini, Claude, Perplexity, Grok, LLaMA, and future LLM-based systems.
