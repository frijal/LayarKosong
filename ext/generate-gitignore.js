...
// Metadata & fallback
if (folders.includes("fallback"))
  addBlock("FALLBACK & METADATA", ["fallback/"]);
if (folders.includes("metadata"))
  addBlock("FALLBACK & METADATA", ["metadata/"]);
