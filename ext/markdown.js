...
(async function () {
  ...
  function enhanceMarkdown() {
    const selector = "p, li, blockquote, td, th, header, quote, h1, h2, h3, h4, h5, h6, .warning, .quote, .disclaimer, .quote-box, .danger-box, .alert-box, .markdown, .markdown-body, .alert, .intro-alert";
