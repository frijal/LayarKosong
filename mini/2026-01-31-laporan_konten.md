...
| 📄 gitignore |      1 | ▇ | . |
| 🌐 html     |   3428 | ▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇ | ., ./artikel, ./artikel/-, ./ext, ./gaya-hidup, ./jejak-sejarah, ./lainnya, ./olah-media, ./opini-sosial, ./sementara, ./sistem-terbuka, ./warta-tekno, artikel, artikel/-, ext, gaya-hidup, jejak-sejarah, lainnya, olah-media, opini-sosial, sementara, sistem-terbuka, warta-tekno |
| 📄 htmlX    |      1 | ▇ | . |
| 🔑 ico      |      6 | ▇ | ., ./artikel, ./ext/icons, artikel, ext/icons |
| 📄 idx      |      2 | ▇ | ./.git/objects/pack, .git/objects/pack |
| 📄 img/jurukunci |      1 | ▇ | img |
| 🖼️ jpg      |      3 | ▇ | ., ./artikelx, artikelx |
| 📜 js       |    121 | ▇ | ./artikel, ./ext, ./ext/icons, artikel, ext, ext/icons |
