...
| 📜 sh    | **13** | dapur, artikel, sementara |
| 📄 svg   | **49** | img, dapur, artikel, ext, favicon.svg |
| 📄 toml  | **1** | wrangler.toml |
| 📄 ts    | **66** | dapur, periksaurutan.ts, deteksi-gambar.ts, sementara, periksaurutan2.ts, perbaikan.ts, carifiel.ts |
| 📄 tsX   | **2** | dapur |
| 📄 txt   | **29** | llms.txt, img, dapur, artikel, deteksi-gambar.txt, EdD8dkmdNLlxREi2LkhJjYOH2kyQbJqM3cBKT5fX.txt, sementara, sitemap.txt, ads.txt, robots.txt |
| 📄 webmanifest | **1** | site.webmanifest |
| 🖼️ webp  | **932** | img, thumbnail.webp |
| 📄 woff2 | **8** | dapur, ext |
