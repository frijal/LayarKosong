...
Dihasilkan pada: 25 February 2026 11:39:16 Balikpapan Time
...
| Jenis File | Jumlah | Histogram |
|:-----------|-------:|:----------|
| 📄 git/refs/remotes/origin/main |      1 | ▇ |

### 📂 Folder: .git/refs/heads

| Jenis File | Jumlah | Histogram |
|:-----------|-------:|:----------|
| 📄 git/refs/heads/main |      1 | ▇ |
...
### 📂 Folder: img/cdn-icons-png.flaticon.com/512/3135

| Jenis File | Jumlah | Histogram |
|:-----------|-------:|:----------|
| 🖼️ webp     |      1 | ▇ |

### 📂 Folder: img/cdn-icons-png.flaticon.com/512/2910

| Jenis File | Jumlah | Histogram |
|:-----------|-------:|:----------|
| 🖼️ webp     |      1 | ▇ |

### 📂 Folder: img/cdn-icons-png.flaticon.com/512/337
...
| 📄 git/HEAD |      1 | ▇ | ./.git |
| 📄 git/config |      1 | ▇ | ./.git |
| 📄 git/description |      1 | ▇ | ./.git |
| 📄 git/index |      1 | ▇ | ./.git |
| 📄 git/info/exclude |      2 | ▇ | ./.git/info, .git/info |
...
| 📄 git/shallow |      1 | ▇ | ./.git |
| 📄 gitignore |      1 | ▇ | . |
| 🌐 html     |   4041 | ▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇ | ., ./artikel, ./artikel/-, ./ext, ./gaya-hidup, ./jejak-sejarah, ./lainnya, ./olah-media, ./opini-sosial, ./sistem-terbuka, ./warta-tekno, artikel, artikel/-, ext, gaya-hidup, jejak-sejarah, lainnya, olah-media, opini-sosial, sistem-terbuka, warta-tekno |
| 🔑 ico      |      6 | ▇ | ., ./artikel, ./ext/icons, artikel, ext/icons |
| 📄 idx      |      2 | ▇ | ./.git/objects/pack, .git/objects/pack |
| 📄 img/jurukunci |      1 | ▇ | img |
| 🖼️ jpg      |      3 | ▇ | ., ./artikelx, artikelx |
| 📜 js       |    143 | ▇ | ./artikel, ./ext, ./ext/icons, ./functions, ./sementara, artikel, ext, ext/icons, functions, sementara |
| 📄 jsX      |      2 | ▇ | ./ext, ext |
| 🗂️ json     |     11 | ▇ | ., ./.well-known, ./artikel, ./ext, ./mini, .well-known, artikel, ext |
| 📄 json5    |      3 | ▇ | ./.github, ./mini |
| 📄 json5Y   |      1 | ▇ | ./.github |
| 📄 lock     |      1 | ▇ | . |
...
| 🐍 py       |     27 | ▇ | ./artikel, ./ext, ./mini, ./sementara, artikel, ext, sementara |
...
| 📄 xml      |     13 | ▇ | . |
| 📄 xsl      |      1 | ▇ | . |
| 📄 yml      |     55 | ▇ | ./.github, ./.github/workflows, .github/workflows |
| **TOTAL** | **6054** | | |
