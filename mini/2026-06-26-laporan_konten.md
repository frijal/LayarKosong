...
| 📄 json  | **11** | img, tsconfig.json, sementara, artikel.json, dapur, redirectmap.json, ext, package.json |
| 📄 lock  | **1** | bun.lock |
| 📝 md    | **11** | README.md, auth.md, sementara, SECURITY.md, CONTRIBUTING.md, llms.md, disclaimer.md, CODE_OF_CONDUCT.md |
| 🖼️ png   | **103** | thumbnail.png, logo.png, icon.png, ChatGPT, Image, Jun, 26,, 2026,, 01_09_27, AM.png, img, artikel, dapur, favicon.png, ext |
| 📜 py    | **5** | sementara, artikel, dapur |
| 📜 sh    | **13** | sementara, artikel, dapur |
| 📄 sql   | **1** | init.sql |
| 📄 svg   | **59** | favicon.svg, img, artikel, dapur, ext |
| 📄 ts    | **77** | search, 0-audit-txt.ts, sementara, 0-komp-editor.ts, functions, 0-dashboard-launcher.ts, 0-dup-finder.ts, 0-cari-hapus.ts, dapur |
...
| 🖼️ webp  | **3145** | thumbnail.webp, img, thumbnail-md.webp, thumbnail-sm.webp |
| 📄 woff2 | **8** | dapur, ext |
