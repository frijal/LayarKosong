...
| 🖼️ png   | **105** | thumbnail.png, logo.png, icon.png, img, artikel, dapur, favicon.png, ext |
| 📜 py    | **5** | sementara, artikel, dapur |
| 📜 sh    | **14** | sementara, artikel, dapur |
| 📄 sql   | **1** | init.sql |
| 🖼️ svg   | **64** | favicon.svg, img, artikel, dapur, ext |
| 📜 ts    | **89** | search, sementara, functions, dapur, index.ts |
| 📄 tsX   | **1** | dapur |
| 📄 tsXX  | **1** | functions |
| 📄 tsY   | **1** | search |
...
| 🖼️ webp  | **3376** | thumbnail.webp, img, thumbnail-md.webp, thumbnail-rg.webp, thumbnail-sm.webp |
| 📄 woff2 | **8** | dapur, ext |
