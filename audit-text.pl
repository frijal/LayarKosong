...
my $target_dir = '.';
my $cari       = 'peretasan tingkat tinggi yang dilakukan oleh para hacker';
my $ganti      = 'modifikasi sistem tingkat tinggi yang dilakukan oleh oknum tak bertanggung jawab';
