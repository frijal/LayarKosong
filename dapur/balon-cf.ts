(() => {
  // 1. Injeksi Kustomisasi Gaya Dinamis & Warna Chat (Desktop vs Mobile)
  ...
  // Menggunakan interface lokal agar terdefinisi dengan ketat
  ...
  if (!document.querySelector('chat-bubble-snippet')) {
    ...
    chatBubble.setAttribute('placeholder', 'Tanya asisten AI Layar Kosong...');
    
    // Sembunyikan branding Cloudflare & Pasang translate Indonesia
