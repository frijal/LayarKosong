...
// --- PENGATURAN KURASI ---
const menuAndalan = [
  "dashboard.html", "dashboard.ts", "github.css", "github-dark.css", "github-dark-dimmed.css", "halaman-pencarian.css", "halaman-pencarian.ts", "header.css", "header.ts", "header-logo-atas.html", "iposbrowser.ts", "json-xml.html", "leaflet.css", "lightbox.ts", "pemandu.css", "pemandu.ts", "response.ts", "sitemap.css", "ujihalaman.html", "homepage.ts", "homepage.css", "sitemap.ts", "data-provider.ts", "tema-newsprint.ts"
];

const menuAsli = [
  "bookmark.json", "icons", "fontawesome-webfonts", "fontawesome.css", "atom-one-dark.min.css", "atom-one-light.min.css", "default.min.css", "github-dark-dimmed.min.css", "github-dark.min.css", "github.min.css", "highlight.js", "marked.min.js", "monokai.min.css", "prism.min.css", "prism-okaidia.min.css", "prism-tomorrow.min.css", "prism-toolbar.min.css", "tokyo-night-dark.min.css", "vs-dark.min.css", "vs.min.css", "html2canvas.min.js", "html2pdf.bundle.min.js", "qrcode.min.js"
];
