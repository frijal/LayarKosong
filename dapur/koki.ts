...
// --- PENGATURAN KURASI ---
const menuAndalan = [
  "dashboard.html", "dashboard.ts", "github.css", "github-dark.css", "github-dark-dimmed.css", "halaman-pencarian.css", "halaman-pencarian.ts", "header.css", "header.ts", "header-logo-atas.html", "homepage.css", "iposbrowser.ts", "json-xml.html", "lightbox.ts", "markdown.ts", "marquee-url.css", "marquee-url.ts", "response.ts", "sitemap.css", "ujihalaman.html"
];

const menuAsli = [
  "bookmark.json", "icons", "fontawesome-webfonts", "fontawesome.css", "atom-one-dark.min.css", "atom-one-light.min.css", "default.min.css", "github-dark-dimmed.min.css", "github-dark.min.css", "github.min.css", "homepage.js", "highlight.js", "monokai.min.css", "prism.min.css", "prism-okaidia.min.css", "prism-tomorrow.min.css", "prism-toolbar.min.css", "sitemap.js", "vs-dark.min.css", "vs.min.css"
];
