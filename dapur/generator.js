...
async function processArticleFile(file, existingFiles) {
  ...
  try {
    ...
    if (needsSave) {
      ...
      await Bun.write(fullPath, content, 'utf8');
    }
...
const generate = async () => {
  ...
  if (hasChanges) {
    ...
    // XML (Sitemap)
    const xmlContent = `<?xml version="1.0" encoding="UTF-8"?>\n<urlset xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:image="http://www.google.com/schemas/image/1.1" xsi:schemaLocation="http://www.sitemaps.org/schemas/sitemap/0.9 http://www.sitemaps.org/schemas/sitemap/0.9/sitemap.xsd http://www.google.com/schemas/sitemap/image/1.1 http://www.google.com/schemas/sitemap/1.1/image.xsd" xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">\n${xmlUrls.join('\n')}\n</urlset>`;
