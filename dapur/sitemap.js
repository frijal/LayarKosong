// ----------------------------------------------------------
// FILE: sitemap-script.js (V6.9 Compatible)
// ----------------------------------------------------------
...
// FUNGSI BARU: Generator URL Cantik V6.9
...
async function loadTOC() {
  try {
    const res = await fetch('artikel.json'); // Asumsi sitemap ada di root
    ...
    Object.keys(grouped)
    .sort((a, b) => new Date(grouped[b][0].lastmod) - new Date(grouped[a][0].lastmod))
    .forEach((cat, index) => {
      ...
      grouped[cat].forEach((item) => {
        ...
        // PERUBAHAN DISINI: Panggil getCleanUrl
        ...
        // Listener untuk simpan history baca
    ...
    if (m) {
      ...
      .map((d) => {
        ...
        // PERUBAHAN DISINI: URL Marquee sesuai folder kategori
